...
import twitterIcon from '../../assets 2/xlogo.png'
            ...
            <Box sx={{py:10,backgroundColor:"#FFF6B2"}}>
                <CustomContainer>
                    ...
                    <Typography sx={{
                        ...
                        <IconBox>
                            <img src={fbIcon} alt="fbIcon" style={{cursor:"pointer",maxWidth:"20%",width:"20px"}} />
                            <img src={twitterIcon} alt="twitterIcon" style={{cursor:"pointer", maxWidth:"20%",width:"20px"}} />
                            <img src={instagramIcon} alt="instagramIcon" style={{cursor:"pointer",maxWidth:"20%",width:"20px"}} />        
                        </IconBox>
                    </Box>
                </CustomContainer>
